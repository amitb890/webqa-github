...
<head>
    ...
    <title>Feature Child Page - Settings</title>
     ...
     <section class="fcs1">
        <div class="fcs1-d1">
            ...
            <div class="fcs1-d1-button">
                <button id="fcs1-d1-btn" class="fr1-d1-button">
                    Sign Up Free
                </button>
            </div>
        </div>
        <div class="fcs1-d2">
            <img src="{{ asset('raw-files-css-js/assets/images/feature-childpage-settings/Group 1048.svg') }}" alt="">
        </div>
     </section>
    <!-- Section 1 Ends -->
     ...
     <section class="fcs3">
        <div class="fcs3-d1">
            ...
            <div class="fcs3-d1-imgdiv">
                <img src="{{ asset('raw-files-css-js/assets/images/feature-childpage-settings/Group 1050.svg') }}" alt="">
            </div>
        </div>
        <div class="fcs3-d2">
    ...
    <!-- Section 4 Starts -->
     <section id="fcs4" class="fr2 section-margin-top-zero section-margin-bottom-zero">
        <div class="fr2-d">
            ...
            <img class="fr2-d-img" src="{{ asset('raw-files-css-js/assets/images/feature-childpage-settings/Group 1009 (1).svg') }}" alt="">
        </div>
     </section>
    <!-- Section 4 Ends -->
                ...
                <div class="fcs5-cards">
                    <div class="fcs5-card">
                        <div class="fcs5-card-question">
                            ...
                            <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/down-arrow.svg') }}" alt="">
                        </div>
        ...
        <div class="fcs6-inner">
            ...
            <div class="fcs6-cards-wrapper cards-paddings">
                <div class="fcs6-cards">
                    ...
                    <div class="fcs6-card">
                        <h6>Unsafe Cross Origin Links</h6>
                        <p>Identifies issues like broken links, slow page speed, and poor keyword usage that may be affecting your search engine rankings.</p>
                    </div>
                    <div class="fcs6-card">
     ...
     <section class="fr4 section-margin">
        <div class="fr4-inner">
            <div class="fr4-d1">
                ...
                <div>
                    <button class="fr4-d1-button">
                        Sign Up Free
                    </button>
                </div>
            </div>
            <div class="fr4-d2">
                <img src="{{ asset('raw-files-css-js/assets/images/feature-childpage-settings/image 71 (3).svg') }}" alt="">
            </div>
        </div>
   </section>
    <!-- Section 8 Ends -->
