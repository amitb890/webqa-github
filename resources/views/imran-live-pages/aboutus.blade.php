...
<body style="background-color: #fff;">
        ...
        <section class="as1">
                <div class="as1-left">
                    <img class="as1-left-img1"  src="{{ asset('raw-files-css-js/assets/images/aboutUs/as1-left-img.svg') }}" alt="">
                    <img class="as1-left-img2"  src="{{ asset('raw-files-css-js/assets/images/aboutUs/as1-left-img-absolute.svg') }}" alt="">
                </div>
                ...
                <div class="as1-right">
                    <img class="as1-right-img2" src="{{ asset('raw-files-css-js/assets/images/aboutUs/as1-right-img-absolute.svg') }}" alt="">
                    <img class="as1-right-img1"  src="{{ asset('raw-files-css-js/assets/images/aboutUs/as1-right-img.svg') }}" alt="">
                </div>
        </section>
        <!-- Section 1 ends -->
            ...
            <div class="container-fluid as2-inner">
                ...
                <div class="as2-dmid">
                    <div class="as2-dmid-img">
                        <img  src="{{ asset('raw-files-css-js/assets/images/aboutUs/Layer 2.svg') }}" alt="">
                    </div>
                ...
                <div class="as2-dlast">
                    <div class="as2-dlast-img">
                        <img  src="{{ asset('raw-files-css-js/assets/images/aboutUs/Layer 3.svg') }}" alt="">
                    </div>
            ...
            <div class="as3-down">
                <div class="as3-down-card">
                    <div class="as3-down-card-imgcon">
                        <img class="as3-down-one-img2" src="{{ asset('raw-files-css-js/assets/images/aboutUs/Layer_1 (1).svg') }}" alt="">
                    </div>
                ...
                <div class="as3-down-card">
                    <div class="as3-down-card-imgcon2">
                           <img class="as3-down-two-img-div1" src="{{ asset('raw-files-css-js/assets/images/aboutUs/Vector.svg') }}" alt="">
                           <img class="as3-down-two-img-div2" src="{{ asset('raw-files-css-js/assets/images/aboutUs/Vector (1).svg') }}" alt=""> 
                    </div>
                ...
                <div class="as3-down-card">
                    <div class="as3-down-card-imgcon">
                        <img class="as3-down-three-img2" src="{{ asset('raw-files-css-js/assets/images/aboutUs/Layer_1 (2).svg') }}" alt="">
                    </div>
                ...
                <div class="as3-down-card">
                    <div class="as3-down-card-imgcon">
                        <img class="as3-down-four-img2" src="{{ asset('raw-files-css-js/assets/images/aboutUs/Layer_1 (3).svg') }}" alt="">
                    </div>
                ...
                <div class="as4-cards">
                    <a href="aboutus.html">
                        ...
                        <div class="as4-card-imgs">
                            <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/Vector.svg') }}" alt="">
                            <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/Vector (1).svg') }}" alt="">
                        </div>
                    ...
                    <a href="aboutus.html">
                        ...
                        <div class="as4-card-img">
                            <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/Layer_1 (1).svg') }}" alt="">
                        </div>
                        <h4>Broken Links</h4>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                    </div>
                    ...
                    <a href="aboutus.html">
                        <div class="as4-card">
                        <div class="as4-card-img">
                            <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/Layer_1 (2).svg') }}" alt="">
                        </div>
                        <h4>Security</h4>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                    </div>
                    ...
                    <a href="aboutus.html">
                        <div class="as4-card">
                        <div class="as4-card-img">
                            <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/Layer_1 (3).svg') }}" alt="">
                        </div>
            ...
            <div class="as5-inner container">
                    ...
                    <div class="as5-cards">
                        <div class="as5-card">
                            <div class="as5-card-img">
                                <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/Ellipse 93.svg') }}" alt="">
                        ...
                        <div class="as5-card">
                            <div class="as5-card-img">
                                <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/Ellipse 94.svg') }}" alt="">
                                <div class="as5-card-img-p">
                                    <h6>Neha Bansal</h6>
                        ...
                        <div class="as5-card">
                            <div class="as5-card-img">
                                <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/Ellipse 95.svg') }}" alt="">
                                <div class="as5-card-img-p">
                                    <h6>Ankit Mehra</h6>
                                    <p>SEO Manager</p>
                                </div>
                ...
                <div class="as5-bottom">
                    <div class="as5-bottom1">
                        <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/left-arrow.svg') }}" alt="">
                    </div>
                    <div class="as5-bottom2">
                        <img src="{{ asset('raw-files-css-js/assets/images/aboutUs/right-arrow.svg') }}" alt="">
                    </div>
                </div>
            </div>
         </section>
        ...
        <!-- Footer Area Start -->
        @include('components.imran-components.aboutus-page-footer')
    <!-- Footer Area End -->
