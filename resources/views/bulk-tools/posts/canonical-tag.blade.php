...
@section('meta-description', 'Bulk Check canonical tags in seconds. Verify presence, self-referencing, and correctness. Get clear Pass/Fail results and export findings for quick fixes.')
