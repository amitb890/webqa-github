...
@section('og-image', 'https://webqa.co/new-assets/assets/images/og/tools/url-slug-test.png')
    ...
    <div class="single-post-content">
        ...
        <ul>
            ...
            <li><b>Keep It Relevant:</b> The slug should be relevant to the content of the page. If your article is
                about homemade pizza recipes, a slug like "/delicious-homemade-pizza" would be appropriate.</li>
            <li><b>Avoid Using Stop Words:</b> Words like "and", "the", "of", and "in" are considered stop words in SEO.
                These are typically ignored by search engines and can be left out of your slug to keep it shorter and
                more readable.</li>
            <li><b>Avoid Duplicates:</b> Ensure that your slug is unique. Having two pages with the same slug can lead
                to confusion for both search engines and users.</li>
            <li><b>Think About Your Audience:</b> Remember, while search engines are important, humans will be reading
                your URLs too. Think about what they would like to see and what would make sense to them.</li>
            <li><b>Stay Consistent:</b> If you have a series of related articles, try to keep the slug structure
                consistent. For example, if you're writing a series of travel guides, you could use slugs like
                "/travel-guide-paris", "/travel-guide-rome", etc.</li>
        </ul>
