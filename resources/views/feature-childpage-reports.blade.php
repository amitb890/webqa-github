...
@section("content")
    ...
    <!-- Section 1 Starts -->
     <section class="fcr1">
        <div class="fcr1-d1">
          <h1 class="fcr1-d1-h">
            Comprehensive Website Reporting Made Simple
          </h1>
          <p class="fcr1-d1-p">
        ...
        <div class="fcr1-d2">
          <img src="{{ asset('new-assets/assets/images/feature-childpage-reports/Group-1039.svg') }}" alt="">
        </div>
     </section>
    <!-- Section 1 Ends -->
    ...
    <!-- Section 2 Starts -->
      <section class="fcr2">
          <div class="fcr2-inner">
            <div class="fcr2-d1">
              <h1>SEO Reports</h1>
              <p>Our Customized Auditing Settings let you define exactly what matters for your website’s success. Choose specific metrics, focus areas, and performance goals tailored to your business. </p>
            </div>
            <div class="fcr2-d2">
              <div class="fcr2-d2-1">
                <img src="{{ asset('new-assets/assets/images/feature-childpage-reports/Group-1040.svg') }}" alt="">
              </div>
              <div class="fcr2-d2-2">
                <h3>Meta Description Reports</h3>
                <ol class="fcr2-d2-2-ol">
                  <li class="fcr2-d2-2-li">
                    <p>
                      Our Customized Auditing Settings let you define exactly what matters for your website’s success.
                    </p>
                  </li>
                  <li class="fcr2-d2-2-li">
                    <p>
                      Choose specific metrics, focus areas, and performance goals tailored to your business. 
                    </p>
                  </li>
                  <li class="fcr2-d2-2-li">
                    <p>
    ...
    <!-- Section 3 Starts -->
      <section class="fcr3">
          <div class="fcr3-inner">
            ...
            <div class="fcr3-d2">
              <div class="fcr3-d2-1">
                <img src="{{ asset('new-assets/assets/images/feature-childpage-reports/Group-1041.svg') }}" alt="">
              </div>
              <div class="fcr3-d2-2">
                <h3>Meta Description Reports</h3>
                <ol class="fcr3-d2-2-ol">
                  <li class="fcr3-d2-2-li">
                    <p>
                      Our Customized Auditing Settings let you define exactly what matters for your website’s success.
                    </p>
                  </li>
    ...
    <!-- Section 4 Starts -->
      <section class="fcr2">
          <div class="fcr2-inner">
            ...
            <div class="fcr2-d2">
              <div class="fcr2-d2-1">
                <img src="{{ asset('new-assets/assets/images/feature-childpage-reports/Group-1042.svg') }}" alt="">
              </div>
              <div class="fcr2-d2-2">
                <h3>Meta Description Reports</h3>
                <ol class="fcr2-d2-2-ol">
    ...
    <!-- Section 5 Starts -->
      <section class="fcr3">
          <div class="fcr3-inner">
            ...
            <div class="fcr3-d2">
              <div class="fcr3-d2-1">
                <img src="{{ asset('new-assets/assets/images/feature-childpage-reports/Group-1043.svg') }}" alt="">
              </div>
              <div class="fcr3-d2-2">
                <h3>Meta Description Reports</h3>
                <ol class="fcr3-d2-2-ol">
