...
Route::namespace("TestDetails")->prefix('test-details')->group(function(){
    ...
    Route::post('/robot-text-test', [App\Http\Controllers\TestDetailsController::class, 'robotTextTest'])->name('test.robot-text-test');
    Route::post('/headings', [App\Http\Controllers\TestDetailsController::class, 'headings'])->name('test.headings-report');
