...
<div class="tag-page-header" style="text-align:center; margin:40px 0;">
    <h1 style="font-size:32px; font-weight:700; color:#222;">
        <?php single_tag_title('Articles On '); ?>
    </h1>
</div>
...
<?php else : ?>
    <p style="text-align:center; margin:40px 0;">No posts found for this tag.</p>
<?php endif; ?>
